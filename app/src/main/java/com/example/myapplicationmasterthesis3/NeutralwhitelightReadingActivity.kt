...
class NeutralwhitelightReadingActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_neutralwhitelight_reading) // Replace with correct Layout
        ...
        seekBar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                ...
                val scale_start = 21 // set minimum of the brightness scale here
                val scale_end = 179 // set maximum here
